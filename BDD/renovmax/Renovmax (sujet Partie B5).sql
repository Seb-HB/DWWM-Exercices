...
BEGIN
 ...
 WHILE @i < @maxi DO
  ...
  SET @dateEmissionTemp = CURDATE() - INTERVAL RAND() * TIMESTAMPDIFF(day, '2018-01-01', CURDATE()) DAY; -- La date doit être aléatoire et comprise entre le 1er janvier 2018 et aujourd’hui
